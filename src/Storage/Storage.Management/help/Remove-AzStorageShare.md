...
HelpUri: https://learn.microsoft.com/powershell/module/az.storage/remove-azstorageshare
...
```
Remove-AzStorageShare [-Name] <string> [-IncludeAllSnapshot] [-SnapshotTime <DateTimeOffset>]
 [-Force] [-PassThru] [-Context <IStorageContext>] [-ServerTimeoutPerRequest <int>]
...
Returns an object representing the removed file share. By default, this cmdlet does not generate any output.
