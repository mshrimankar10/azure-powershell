...
HelpUri: https://learn.microsoft.com/powershell/module/az.storage/set-azstorageblobimmutabilitypolicy
...
```
Set-AzStorageBlobImmutabilityPolicy [-Blob] <string> [-Container] <string>
 -ExpiresOn <DateTimeOffset> [-PolicyMode <string>] [-TagCondition <string>]
