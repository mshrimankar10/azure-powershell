...
HelpUri: https://learn.microsoft.com/powershell/module/az.storage/enable-azstoragecontainerdeleteretentionpolicy
...
```
Enable-AzStorageContainerDeleteRetentionPolicy [-ResourceGroupName] <string>
 [-StorageAccountName] <string> -RetentionDays <int> [-PassThru]
...
```
Enable-AzStorageContainerDeleteRetentionPolicy -StorageAccount <PSStorageAccount>
 -RetentionDays <int> [-PassThru] [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Enable-AzStorageContainerDeleteRetentionPolicy [-ResourceId] <string> -RetentionDays <int>
