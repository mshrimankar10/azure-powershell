...
HelpUri: https://learn.microsoft.com/powershell/module/az.storage/remove-azdatalakegen2aclrecursive
...
```
Remove-AzDataLakeGen2AclRecursive [-FileSystem] <String> [[-Path] <String>]
