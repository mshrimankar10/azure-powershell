...
HelpUri: https://learn.microsoft.com/powershell/module/az.storage/new-azstorageshare
...
```
New-AzStorageShare [-Name] <String> [-Protocol <String>]
 [-EnableSnapshotVirtualDirectoryAccess <Boolean>] [-Context <IStorageContext>]
...
```
New-AzStorageShare [-Name] <string> [-Protocol <string>]
 [-EnableSnapshotVirtualDirectoryAccess <bool>] [-Context <IStorageContext>]
