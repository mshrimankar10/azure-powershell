...
HelpUri: https://learn.microsoft.com/powershell/module/az.storage/enable-azstoragebloblastaccesstimetracking
...
```
Enable-AzStorageBlobLastAccessTimeTracking [-ResourceGroupName] <String>
