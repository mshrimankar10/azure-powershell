...
HelpUri: https://learn.microsoft.com/powershell/module/az.storage/new-azstoragetaskassignment
...
New-AzStorageTaskAssignment -AccountName <String> -Name <String> -ResourceGroupName <String>
 -Description <String> -ReportPrefix <String> -TaskId <String> -TriggerType <String>
 [-SubscriptionId <String>] [-Enabled] [-EndBy <DateTime>] [-Interval <Int32>]
 [-IntervalUnit <String>] [-StartFrom <DateTime>] [-StartOn <DateTime>]
 [-TargetExcludePrefix <String[]>] [-TargetPrefix <String[]>] [-DefaultProfile <PSObject>] [-AsJob]
...
New-AzStorageTaskAssignment -AccountName <string> -Name <string> -ResourceGroupName <string>
 ...
 [-SubscriptionId <string>] [-EndBy <datetime>] [-Interval <int>] [-IntervalUnit <string>]
 [-StartFrom <datetime>] [-StartOn <datetime>] [-TargetExcludePrefix <string[]>]
 [-TargetPrefix <string[]>] [-DefaultProfile <psobject>] [-AsJob] [-Break]
