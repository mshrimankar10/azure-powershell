...
HelpUri: https://learn.microsoft.com/powershell/module/az.storage/remove-azstoragetaskassignment
...
```
Remove-AzStorageTaskAssignment -InputObject <IStorageIdentity> [-DefaultProfile <psobject>] [-AsJob]
...
ParameterSets:
- Name: DeleteViaIdentityStorageAccount
  Position: Named
  IsRequired: true
  ValueFromPipeline: false
  ValueFromPipelineByPropertyName: false
