...
```
Get-AzExpressRouteLagMember -LinkName <String> -MemberName <String>
 -ExpressRouteLagInputObject <IExpressRouteLagIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### GetViaIdentityLink
```
Get-AzExpressRouteLagMember -MemberName <String> -LinkInputObject <IExpressRouteLagIdentity>
...
```yaml
Type: System.String
Parameter Sets: List, Get, GetViaIdentityExpressRouteLag
Aliases:
