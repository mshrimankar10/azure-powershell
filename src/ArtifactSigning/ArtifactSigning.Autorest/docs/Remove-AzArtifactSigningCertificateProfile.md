...
online version: https://learn.microsoft.com/powershell/module/az.artifactsigning/remove-azartifactsigningcertificateprofile
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzArtifactSigningCertificateProfile -AccountName <String> -ProfileName <String>
...
### DeleteViaIdentity
```
Remove-AzArtifactSigningCertificateProfile -InputObject <IArtifactSigningIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentityCodeSigningAccount
```
Remove-AzArtifactSigningCertificateProfile -CodeSigningAccountInputObject <IArtifactSigningIdentity>
