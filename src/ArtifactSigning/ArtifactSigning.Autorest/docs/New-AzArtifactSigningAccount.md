...
online version: https://learn.microsoft.com/powershell/module/az.artifactsigning/new-azartifactsigningaccount
schema: 2.0.0
---
...
```
New-AzArtifactSigningAccount -AccountName <String> -ResourceGroupName <String> -Location <String>
...
```
New-AzArtifactSigningAccount -AccountName <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzArtifactSigningAccount -AccountName <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
