...
online version: https://learn.microsoft.com/powershell/module/az.artifactsigning/new-azartifactsigningcertificateprofile
schema: 2.0.0
---
...
```
New-AzArtifactSigningCertificateProfile -AccountName <String> -ProfileName <String>
...
### Example 1: Create New Artifact signing Certificate Profile
```powershell
...
This command creates new artifact signing certificate profile.
