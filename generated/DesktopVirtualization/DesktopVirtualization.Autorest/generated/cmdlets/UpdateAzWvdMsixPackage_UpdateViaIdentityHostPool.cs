...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/msixPackages/{msixPackageFullName}", ApiVersion = "2026-01-01-preview")]
    public partial class UpdateAzWvdMsixPackage_UpdateViaIdentityHostPool : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.IContext
    {
        ...
        /// <summary>Backing field for <see cref="MsixPackage" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IMsixPackagePatch _msixPackage;

        /// <summary>MSIX Package properties that can be patched.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "MSIX Package properties that can be patched.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"MSIX Package properties that can be patched.",
        SerializedName = @"msixPackage",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IMsixPackagePatch) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Models.IMsixPackagePatch MsixPackage { get => this._msixPackage; set => this._msixPackage = value; }
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (HostPoolInputObject?.Id != null)
                    {
                        ...
                        await this.Client.MsixPackagesUpdateViaIdentity(HostPoolInputObject.Id, MsixPackage, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.SerializationMode.IncludeUpdate);
                    }
                    else
                    {
                        ...
                        await this.Client.MsixPackagesUpdate(HostPoolInputObject.SubscriptionId ?? null, HostPoolInputObject.ResourceGroupName ?? null, HostPoolInputObject.HostPoolName ?? null, FullName, MsixPackage, onOk, onDefault, this, Pipeline, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualization.Runtime.SerializationMode.IncludeUpdate);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzWvdMsixPackage_UpdateViaIdentityHostPool" /> cmdlet class.
        /// </summary>
        public UpdateAzWvdMsixPackage_UpdateViaIdentityHostPool()
        {
